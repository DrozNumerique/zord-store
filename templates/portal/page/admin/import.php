...
<?php $this->render('file'); ?>
                    ...
                    <div id="import-notify" style="display:none;">
                        ...
                        <div class="admin-progress">
                       	...
                       	<div id="import-report" class="admin-report" style="display:none;" data-over="false">
                            <img id="import-wait" src='/img/wait.gif' class="spinner" style="height:1em; display:none;"></img>
                       	</div>       
                   	</div>
               	</div>         	
